...
<body dir="rtl">
      ...
      <form class="box" method="post" action="addition_code.php" enctype="multipart/form-data">
        <div class="col">
          <div class="row sp-row">
            ...
            <div class="row ">
              ...
              <div class="col">
                ...
                <input type="radio" name="decision_type" value="<?= $decision_types_row['decision_type_id'] ?>">
              </div>
              <?php } ?>
          ...
          <div class="row sp-row">
            ...
            <div class="row ">
              <div class="col">
                <h5>نعم</h5><input class="resp-yes" type="radio" name="needs_action" value="1" required
                  aria-required="true">
              </div>
              <div class="col">
                <h5>لا</h5><input class="resp-no" type="radio" name="needs_action" value="0" required
                  aria-required="true">
              </div>
            </div>
          </div>
  ...
  <p style="color: red; font-weight: bold; text-align: center;">
    يجب استخدام POST لتحميل الصفحة. سيتم تحويلك إلى صفحة المجالس بعد 5 ثواني. أو اضغط<a href="meetings.php"> هنا</a>
  </p>
