    ...
    <div class="container">
      ...
      <form class="box">
        <div class="col">
          ...
          <div class="row">
            <h4>اسم المستخدم كامل</h4><input type="text" placeholder="اسم المستخدم كامل" />
          </div>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="row">
              ...
              <h4>مفعل</h4><input type="radio" name="radio" checked />


              <h4>موقوف</h4><input type="radio" name="radio" />
          ...
          <div class="row">
            <button type="submit" class="btn-basic">تعديل</button>
          </div>
        </div>
      </form>
